...
CREATE TABLE `doctor` (
  ...
  `call_rule` text,
  `opr_time` varchar(50) NOT NULL DEFAULT '',
...
) ENGINE=InnoDB AUTO_INCREMENT=116172 DEFAULT CHARSET=utf8;
...
CREATE TABLE `patient_queue` (
  ...
  `sub_queue_type` varchar(20) DEFAULT NULL,
  ...
  `queue_type_source_id` varchar(50) DEFAULT NULL,
...
CREATE TABLE `queue_type` (
  ...
  `is_reorder` int(4) DEFAULT NULL,
  `is_checkin` int(4) DEFAULT NULL,
  `is_pretriage` int(4) DEFAULT NULL,
  `avg_minute` int(11) DEFAULT '0',
  `name` varchar(100) NOT NULL,
  `displayname` varchar(255) NOT NULL,
  `is_reserve` int(4) DEFAULT NULL,
  `pass_first_flag` int(11) DEFAULT NULL,
  `pass_flag_step` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=55111 DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `tfw_attach` VALUES ('308', null, '1493342699940.jpg', '/upload\\20170802\\1501662528034.jpg', '1', '1', '2017-08-02 16:28:48');
INSERT INTO `tfw_attach` VALUES ('309', null, '医生.png', '/upload\\20170802\\1501663965350.png', '1', '1', '2017-08-02 16:52:45');
INSERT INTO `tfw_attach` VALUES ('310', null, '队列.png', '/upload\\20170802\\1501664097757.png', '1', '1', '2017-08-02 16:54:57');
INSERT INTO `tfw_attach` VALUES ('311', null, '排班.png', '/upload\\20170802\\1501664196117.png', '1', '1', '2017-08-02 16:56:36');
INSERT INTO `tfw_attach` VALUES ('312', null, '患者.png', '/upload\\20170802\\1501664235213.png', '1', '1', '2017-08-02 16:57:15');
...
-- Records of tfw_dept
-- ----------------------------
--INSERT INTO `tfw_dept` VALUES ('14', '0', '0', 'RZL', 'WEB-SERVICE RZL', '', '0');
--I--NSERT INTO `tfw_dept` VALUES ('15', '1', '14', '研发部', '研发部', '', '0');
--INSERT INTO `tfw_dept` VALUES ('16', '3', '0', '云阳中医院', '重庆云阳中医院', '', '0');
--INSERT INTO `tfw_dept` VALUES ('17', '1', '16', '信息科', '云阳中医院信息科', '', '0');
...
INSERT INTO `tfw_dict` VALUES ('60', '108', '0', '0', 'SQL类型', '', '0');
INSERT INTO `tfw_dict` VALUES ('61', '108', '1', '60', 'FUN', '', '2');
INSERT INTO `tfw_dict` VALUES ('62', '108', '2', '60', 'TEXT', '', '2');
...
INSERT INTO `tfw_menu` VALUES ('137', 'pager_pagerterminal', 'pager', 'edit', '屏幕编辑', 'btn btn-xs btn-white | fa fa-pencil bigger-120', '/pager/pagerterminal', '5', '3', null, null, '800*520', '1', '1', null, '1');
...
INSERT INTO `tfw_menu` VALUES ('155', 'source', 'office', '', '数据源管理(二)', 'fa fa-bell', '/source/', '10', '2', null, null, '800*520', '1', '0', null, '0');
INSERT INTO `tfw_menu` VALUES ('156', 'source_add', 'source', 'add', '新增', 'btn btn-xs btn-white | fa fa-floppy-o bigger-120', '/source/add', '1', '3', null, null, '800*520', '1', '0', null, '0');
INSERT INTO `tfw_menu` VALUES ('157', 'source_remove', 'source', 'remove', '删除', 'btn btn-xs btn-white | fa fa-times  bigger-120', '/source/remove', '2', '3', null, null, '800*520', '1', '0', null, '0');
INSERT INTO `tfw_menu` VALUES ('158', 'source_edit', 'source', 'edit', '修改', 'btn btn-xs btn-white | fa fa-pencil  bigger-120', '/source/edit', '3', '3', null, null, '800*520', '1', '0', null, '0');
INSERT INTO `tfw_menu` VALUES ('159', 'item', 'office', '', '数据项管理(二)', 'fa fa-bell', '/item/', '11', '2', null, null, '800*520', '1', '0', null, '0');
INSERT INTO `tfw_menu` VALUES ('160', 'item_add', 'item', 'add', '新增', 'btn btn-xs btn-white | fa fa-floppy-o bigger-120', '/item/add', '1', '3', null, null, '800*520', '1', '0', null, '0');
INSERT INTO `tfw_menu` VALUES ('161', 'item_remove', 'item', 'remove', '删除', 'btn btn-xs btn-white | fa fa-times  bigger-120', '/item/remove', '2', '3', null, null, '800*520', '1', '0', null, '0');
INSERT INTO `tfw_menu` VALUES ('162', 'item_edit', 'item', 'edit', '修改', 'btn btn-xs btn-white | fa fa-pencil  bigger-120', '/item/edit', '3', '3', null, null, '800*520', '1', '0', null, '0');
...
INSERT INTO `tfw_relation` VALUES ('3389', '92', '1');
INSERT INTO `tfw_relation` VALUES ('3390', '105', '1');
INSERT INTO `tfw_relation` VALUES ('3391', '106', '1');
INSERT INTO `tfw_relation` VALUES ('3392', '107', '1');
INSERT INTO `tfw_relation` VALUES ('3393', '108', '1');
INSERT INTO `tfw_relation` VALUES ('3394', '130', '1');
INSERT INTO `tfw_relation` VALUES ('3395', '115', '1');
INSERT INTO `tfw_relation` VALUES ('3396', '116', '1');
INSERT INTO `tfw_relation` VALUES ('3397', '117', '1');
INSERT INTO `tfw_relation` VALUES ('3398', '118', '1');
INSERT INTO `tfw_relation` VALUES ('3399', '120', '1');
INSERT INTO `tfw_relation` VALUES ('3400', '121', '1');
INSERT INTO `tfw_relation` VALUES ('3401', '122', '1');
INSERT INTO `tfw_relation` VALUES ('3402', '123', '1');
INSERT INTO `tfw_relation` VALUES ('3403', '132', '1');
INSERT INTO `tfw_relation` VALUES ('3404', '137', '1');
INSERT INTO `tfw_relation` VALUES ('3405', '125', '1');
INSERT INTO `tfw_relation` VALUES ('3406', '126', '1');
INSERT INTO `tfw_relation` VALUES ('3407', '127', '1');
INSERT INTO `tfw_relation` VALUES ('3408', '128', '1');
INSERT INTO `tfw_relation` VALUES ('3409', '133', '1');
INSERT INTO `tfw_relation` VALUES ('3410', '134', '1');
INSERT INTO `tfw_relation` VALUES ('3411', '135', '1');
INSERT INTO `tfw_relation` VALUES ('3412', '136', '1');
INSERT INTO `tfw_relation` VALUES ('3413', '138', '1');
INSERT INTO `tfw_relation` VALUES ('3414', '139', '1');
INSERT INTO `tfw_relation` VALUES ('3415', '140', '1');
INSERT INTO `tfw_relation` VALUES ('3416', '154', '1');
INSERT INTO `tfw_relation` VALUES ('3417', '142', '1');
INSERT INTO `tfw_relation` VALUES ('3418', '143', '1');
INSERT INTO `tfw_relation` VALUES ('3419', '144', '1');
INSERT INTO `tfw_relation` VALUES ('3420', '145', '1');
INSERT INTO `tfw_relation` VALUES ('3421', '155', '1');
INSERT INTO `tfw_relation` VALUES ('3422', '156', '1');
INSERT INTO `tfw_relation` VALUES ('3423', '157', '1');
INSERT INTO `tfw_relation` VALUES ('3424', '158', '1');
INSERT INTO `tfw_relation` VALUES ('3425', '159', '1');
INSERT INTO `tfw_relation` VALUES ('3426', '160', '1');
INSERT INTO `tfw_relation` VALUES ('3427', '161', '1');
INSERT INTO `tfw_relation` VALUES ('3428', '162', '1');
INSERT INTO `tfw_relation` VALUES ('3429', '1', '1');
INSERT INTO `tfw_relation` VALUES ('3430', '8', '1');
INSERT INTO `tfw_relation` VALUES ('3431', '9', '1');
INSERT INTO `tfw_relation` VALUES ('3432', '10', '1');
INSERT INTO `tfw_relation` VALUES ('3433', '11', '1');
INSERT INTO `tfw_relation` VALUES ('3434', '12', '1');
INSERT INTO `tfw_relation` VALUES ('3435', '13', '1');
INSERT INTO `tfw_relation` VALUES ('3436', '14', '1');
INSERT INTO `tfw_relation` VALUES ('3437', '15', '1');
INSERT INTO `tfw_relation` VALUES ('3438', '16', '1');
INSERT INTO `tfw_relation` VALUES ('3439', '17', '1');
INSERT INTO `tfw_relation` VALUES ('3440', '18', '1');
INSERT INTO `tfw_relation` VALUES ('3441', '19', '1');
INSERT INTO `tfw_relation` VALUES ('3442', '20', '1');
INSERT INTO `tfw_relation` VALUES ('3443', '21', '1');
INSERT INTO `tfw_relation` VALUES ('3444', '22', '1');
INSERT INTO `tfw_relation` VALUES ('3445', '23', '1');
INSERT INTO `tfw_relation` VALUES ('3446', '24', '1');
INSERT INTO `tfw_relation` VALUES ('3447', '2', '1');
INSERT INTO `tfw_relation` VALUES ('3448', '3', '1');
INSERT INTO `tfw_relation` VALUES ('3449', '4', '1');
INSERT INTO `tfw_relation` VALUES ('3450', '5', '1');
INSERT INTO `tfw_relation` VALUES ('3451', '6', '1');
INSERT INTO `tfw_relation` VALUES ('3452', '7', '1');
INSERT INTO `tfw_relation` VALUES ('3453', '25', '1');
INSERT INTO `tfw_relation` VALUES ('3454', '26', '1');
INSERT INTO `tfw_relation` VALUES ('3455', '27', '1');
INSERT INTO `tfw_relation` VALUES ('3456', '28', '1');
INSERT INTO `tfw_relation` VALUES ('3457', '29', '1');
INSERT INTO `tfw_relation` VALUES ('3458', '30', '1');
INSERT INTO `tfw_relation` VALUES ('3459', '31', '1');
INSERT INTO `tfw_relation` VALUES ('3460', '32', '1');
INSERT INTO `tfw_relation` VALUES ('3461', '33', '1');
INSERT INTO `tfw_relation` VALUES ('3462', '34', '1');
INSERT INTO `tfw_relation` VALUES ('3463', '35', '1');
INSERT INTO `tfw_relation` VALUES ('3464', '36', '1');
INSERT INTO `tfw_relation` VALUES ('3465', '37', '1');
INSERT INTO `tfw_relation` VALUES ('3466', '38', '1');
INSERT INTO `tfw_relation` VALUES ('3467', '39', '1');
INSERT INTO `tfw_relation` VALUES ('3468', '40', '1');
INSERT INTO `tfw_relation` VALUES ('3469', '41', '1');
INSERT INTO `tfw_relation` VALUES ('3470', '42', '1');
INSERT INTO `tfw_relation` VALUES ('3471', '43', '1');
INSERT INTO `tfw_relation` VALUES ('3472', '44', '1');
INSERT INTO `tfw_relation` VALUES ('3473', '45', '1');
INSERT INTO `tfw_relation` VALUES ('3474', '46', '1');
INSERT INTO `tfw_relation` VALUES ('3475', '47', '1');
INSERT INTO `tfw_relation` VALUES ('3476', '48', '1');
INSERT INTO `tfw_relation` VALUES ('3477', '49', '1');
INSERT INTO `tfw_relation` VALUES ('3478', '56', '1');
INSERT INTO `tfw_relation` VALUES ('3479', '57', '1');
INSERT INTO `tfw_relation` VALUES ('3480', '58', '1');
INSERT INTO `tfw_relation` VALUES ('3481', '59', '1');
INSERT INTO `tfw_relation` VALUES ('3482', '60', '1');
INSERT INTO `tfw_relation` VALUES ('3483', '61', '1');
INSERT INTO `tfw_relation` VALUES ('3484', '62', '1');
INSERT INTO `tfw_relation` VALUES ('3485', '63', '1');
INSERT INTO `tfw_relation` VALUES ('3486', '64', '1');
INSERT INTO `tfw_relation` VALUES ('3487', '65', '1');
INSERT INTO `tfw_relation` VALUES ('3488', '81', '1');
INSERT INTO `tfw_relation` VALUES ('3489', '82', '1');
INSERT INTO `tfw_relation` VALUES ('3490', '84', '1');
INSERT INTO `tfw_relation` VALUES ('3491', '85', '1');
INSERT INTO `tfw_relation` VALUES ('3492', '86', '1');
INSERT INTO `tfw_relation` VALUES ('3493', '87', '1');
INSERT INTO `tfw_relation` VALUES ('3494', '83', '1');
INSERT INTO `tfw_relation` VALUES ('3495', '88', '1');
INSERT INTO `tfw_relation` VALUES ('3496', '89', '1');
INSERT INTO `tfw_relation` VALUES ('3497', '90', '1');
INSERT INTO `tfw_relation` VALUES ('3498', '91', '1');
INSERT INTO `tfw_relation` VALUES ('3499', '98', '1');
INSERT INTO `tfw_relation` VALUES ('3500', '99', '1');
INSERT INTO `tfw_relation` VALUES ('3501', '100', '1');
INSERT INTO `tfw_relation` VALUES ('3502', '101', '1');
INSERT INTO `tfw_relation` VALUES ('3503', '102', '1');
INSERT INTO `tfw_relation` VALUES ('3504', '103', '1');
INSERT INTO `tfw_relation` VALUES ('3505', '104', '1');
...
-- Records of tfw_user
-- ----------------------------
INSERT INTO `tfw_user` VALUES ('1', 'admin', '4779e4a9903dfb08f9f877791c516a73', 'admin', '冉志林', '1992-09-15 00:00:00', '1', '239574647@qq.com', '13370799172', '1', '15', '1', '2016-01-29 08:49:53', '27');
INSERT INTO `tfw_user` VALUES ('2', 'shine', 'e2556fa1dee6f0ccc1c31da5f3823550', 'nyuhf', '信息科', '2017-08-21 11:07:43', '1', '', '', '2', '17', '1', '2017-08-21 11:07:57', null);
...
CREATE TABLE `triage` (
  ...
  `call_buffer` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  `ip` varchar(15) NOT NULL,
  `description` text,
  `create_time` datetime NOT NULL,
  `reorder_type` tinyint(4) NOT NULL,
  `return_flag_step` int(11) DEFAULT NULL,
