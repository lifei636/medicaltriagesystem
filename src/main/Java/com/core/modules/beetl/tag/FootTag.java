...
public class FootTag extends Tag {
	...
	public void render() {
		try {
			 ...
			 * sb.append("     &nbsp;copyright &copy; "+year); sb.append("   </span>");
			 * sb.append("&nbsp; &nbsp;"); sb.append("  </div>");
			 * sb.append("  <div style=\"padding-bottom:1px;\">");
			 * sb.append("   <span class=\"bigger-120\">");
			 * sb.append("    <span style=\"font-size:4px;\">技术支持：</span>");
			 * sb.append("    <span style=\"font-size:4px;\" id=\"support_tonbusoft\">" +
			 * company + "</span>"); sb.append("   </span>"); sb.append("  </div>");
			 * sb.append(" </div>"); sb.append("</div>"); sb.
			 * append("<a href=\"#\" id=\"btn-scroll-up\" class=\"btn-scroll-up btn btn-sm btn-inverse\">"
			 * ); sb.
			 * append(" <i class=\"ace-icon fa fa-angle-double-up icon-only bigger-110\">");
			 * sb.append("  顶部"); sb.append(" </i>"); sb.append("</a>");
			 */
