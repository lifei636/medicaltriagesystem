...
import com.core.interfaces.IGrid;
import com.core.interfaces.IQuery;
import com.core.toolbox.Func;
import com.core.toolbox.support.SqlKeyword;
...
public abstract class BaseGridFactory implements IGrid {
	 ...
	 * @return Object
	 */
	protected Object basePaginate(Integer page, Integer rows, String source, String para, String sort, String order,
	...
	private Object paginateById(Integer page, Integer rows, String sqlId, String para, String sort, String order,
			IQuery intercept, BaseController ctrl) {
	...
	private Object paginateBySql(Integer page, Integer rows, String sqlTemplate, String para, String sort, String order,
			IQuery intercept, BaseController ctrl) {
		...
		Object list = null;
		String orderBy = (Func.isEmpty(map.get(Const.ORDER_BY_STR))) ? " "
				: (" order by " + Func.format(map.get(Const.ORDER_BY_STR)));
	...
	private static Map<String, Object> getSqlMap(String para, String sort, String order) {
		Map<String, Object> map = FastJsonFactory.me().getJson()
				.parse(Func.isEmpty(Func.decodeUrl(para)) ? null : Func.decodeUrl(para), HashMap.class);
		if (Func.isEmpty(map)) {
			map = new HashMap<>();
		}
