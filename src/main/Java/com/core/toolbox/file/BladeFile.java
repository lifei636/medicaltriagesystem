...
public class BladeFile {
	...
	public BladeFile(UploadFile file) {
		...
		this.uploadPath = Cst.me().getUploadRealPath() + File.separator + DateKit.getDays() + File.separator
				+ this.originalFileName;
		this.uploadVirtualPath = Cst.me().getUploadCtxPath().replace(Cst.me().getContextPath(), "") + File.separator
				+ DateKit.getDays() + File.separator + this.originalFileName;
	}
