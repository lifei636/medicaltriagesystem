...
import com.core.exception.ToolBoxException;
import com.core.jfinal.ext.kit.JStrKit;
import com.core.toolbox.Conver;
...
public class BeanKit {
	 ...
	 */
	/*
	 * public static PropertyDescriptor getPropertyDescriptor(Class<?> clazz, final
	 * String fieldName) throws IntrospectionException{ PropertyDescriptor[]
	 * propertyDescriptors = getPropertyDescriptors(clazz); for (PropertyDescriptor
	 * propertyDescriptor : propertyDescriptors) { if(ObjectUtil.equals(fieldName,
	 * propertyDescriptor.getName())){ return propertyDescriptor; } } return null; }
	 */
	 ...
	 * @return ("f_it_xl","1")
	 */
	public static Map<String, Object> map2Map(Map<?, ?> oldMap, Map<String, Object> switchMap) {
		Map<String, Object> map = new HashMap<>();
		for (String key : switchMap.keySet()) {
			map.put(switchMap.get(key).toString().toLowerCase(), oldMap.get(key));
		}
		return map;
	}
	 ...
	 */
	public static Map<String, Object> reverse(Map<String, Object> reverseMap, Object model) {
