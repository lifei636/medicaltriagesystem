...
package com.core.jfinal.ext.kit.excel;
...
public class Rule {
	...
	public static class Cell {
		...
		public String toString() {
			return "Cell{" + "index=" + index + ", attribute='" + attribute + '\'' + ", convert='" + convert + '\''
					+ ", validate='" + validate + '\'' + '}';
		}
	}
	...
	@Override
	public String toString() {
		return "Rule{" + "name='" + name + '\'' + ", sheetNo=" + sheetNo + ", start=" + start + ", end=" + end
				+ ", rowFilter='" + rowFilter + '\'' + ", preExcelProcessor='" + preExcelProcessor + '\''
				+ ", postExcelProcessor='" + postExcelProcessor + '\'' + ", preListProcessor='" + preListProcessor
				+ '\'' + ", postListProcessor='" + postListProcessor + '\'' + ", cells=" + cells + '}';
	}
}
