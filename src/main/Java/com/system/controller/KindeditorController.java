...
import com.core.toolbox.file.BladeFile;
import com.core.toolbox.file.UploadFileUtils;
...
public class KindeditorController extends BaseController {
	...
	public void initfile() {
		...
		Db dao = Db.init();
		List<Record> file = dao.selectList(
				"select ID as \"id\",NAME as \"name\",URL as \"url\" from TFW_ATTACH where ID in (#{join(ids)})",
