...
import com.system.meta.intercept.RoleIntercept;
import com.system.meta.intercept.RoleValidator;
import com.system.model.Role;
import com.system.service.RoleService;
import com.system.service.impl.RoleServiceImpl;
...
public class RoleController extends AdminBaseController {
	...
	public void view() {
		...
		maps.set("deptName", Func.getDeptName(role.getDeptid())).set("pName", pName);
