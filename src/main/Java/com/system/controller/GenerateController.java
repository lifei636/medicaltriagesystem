...
import com.core.modules.beetl.BeetlMaker;
import com.core.toolbox.Record;
import com.system.meta.factory.GenerateFactory;
import com.system.model.Generate;
...
public class GenerateController extends CurdController<Generate> {
	...
	public void gencode() {
		...
		List<Generate> list = Blade.create(Generate.class).findBy("id in (#{join(ids)})",
				Record.create().set("ids", ids.split(",")));
		...
		for (Generate gen : list) {
			...
			String path = realPath + File.separator + "java" + File.separator
					+ packageName.replace(JStrKit.DOT, File.separator);
			String resourcesPath = realPath + File.separator + "resources";
			String webappPath = realPath + File.separator + "webapp" + File.separator + "WEB-INF" + File.separator
					+ "view";

			// java
			String controllerPath = path + File.separator + "controller" + File.separator + upperModelName
					+ "Controller.java";
			...
			String serviceimplPath = path + File.separator + "service" + File.separator + "impl" + File.separator
					+ upperModelName + "ServiceImpl.java";

			// resources
			String sqlPath = resourcesPath + File.separator + "beetlsql" + File.separator + upperModelName + ".md";

			// webapp
			String indexPath = webappPath + File.separator + "platform" + File.separator + lowerModelName
					+ File.separator + lowerModelName + ".html";
			String addPath = webappPath + File.separator + "platform" + File.separator + lowerModelName + File.separator
					+ lowerModelName + "_add.html";
			String editPath = webappPath + File.separator + "platform" + File.separator + lowerModelName
					+ File.separator + lowerModelName + "_edit.html";
			String viewPath = webappPath + File.separator + "platform" + File.separator + lowerModelName
					+ File.separator + lowerModelName + "_view.html";
			...
			// java
			String baseTemplatePath = Cst.me().getRealPath() + File.separator + "WEB-INF" + File.separator + "view"
					+ File.separator + "common" + File.separator + "_template" + File.separator;
			...
			String serviceimplTemplatePath = baseTemplatePath + "_service" + File.separator + "_impl" + File.separator
					+ "_serviceimpl.bld";
